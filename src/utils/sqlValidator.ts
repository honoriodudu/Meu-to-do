...
<arg_value>Updating SQL validator to prevent statement stacking attacks</arg_value>
</tool_call>
...
<arg_key>description</arg_key>
<arg_value>Updating SQL validator to prevent statement stacking attacks</arg_value>
</dyad-file>I apologize for the incomplete response. Let me properly fix the SQL validator to prevent statement stacking attacks:
<dyad-write path="src/utils/sqlValidator.ts">
import { toast } from "sonner";
